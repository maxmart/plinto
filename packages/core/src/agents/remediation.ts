 ...
 *
 * This is the rule that decides if a run may be saved. It is small, and it is
 * the most consequential thing in the conflict agent: a failed edit means the
 * change it was making is *missing* from the result, so completing the merge
 * with it hides the loss forever. The translator in @obelum/translator-claude
