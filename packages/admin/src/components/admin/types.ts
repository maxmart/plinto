// The ops layer names this; the admin only displays it.
export type { StalenessStatus } from '@plinto/core/ops/content';
import type { StalenessStatus } from '@plinto/core/ops/content';
