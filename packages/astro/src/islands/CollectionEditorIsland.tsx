/**
 * The composition root for the CollectionEditor route.
 *
 ...
 */
import CollectionEditorPage from '@plinto/admin/components/islands/CollectionEditorPage.tsx';
import { PlintoProvider } from '@plinto/admin/context.tsx';
import { plinto } from '../plinto';

export default function CollectionEditorIsland() {
  return (
